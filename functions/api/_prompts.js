...
// ESM twin of api/_prompts.js for Cloudflare Pages Functions.
// If you change prompts, update both this file AND api/_prompts.js.
...
输出 token 必须与上面清单一字不差：ASCII 方括号，全大写英文，带数字（如 [ANGLE1_TITLE]、[ANGLE2_BODY]）。
- ❌ [角度一：xxx]
- ❌ [Angle 1: xxx]
- ❌ 角度1：xxx
- ❌ 自创 token，或把 title 和 body 合并进一个方括号
- ✅ [ANGLE1_TITLE] 后面换行或空格接内容，[ANGLE1_BODY] 另起一行接内容
...
BODY 可能的解读（每个角度 3–4 句话，角度间有实质差异）
...
export { buildSystemPrompt, buildUserMessage };
